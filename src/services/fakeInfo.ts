...
export default async function getFakeInfo(): Promise<FakePerson> {
    ...
    const fullNameAndGender: { firstName: string; lastName: string; gender: 'male' | 'female' } = setFullNameAndGender();
    const address: { street: string; number: string; floor: number; door: string; postal_code: string; town_name: string } = await setAddress();
...
function setFullNameAndGender(): { firstName: string; lastName: string; gender: 'male' | 'female' } {
...
async function setAddress(): Promise<{ street: string; number: string; floor: number; door: string; postal_code: string; town_name: string }> {
